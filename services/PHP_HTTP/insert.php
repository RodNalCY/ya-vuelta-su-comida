...
if (
    ...
    if ($s_result) {
        ...
        // print_r($neo_ticket);
        $q_insert = "INSERT INTO tb_ventas (s_ticket, s_nombres_apellidos, s_email, s_celular, s_direccion, s_medio_pago, s_precio_producto, s_monto_pagar, s_monto_vuelto) VALUES ($neo_ticket, '$name', '$email', '$phone', '$place', '$medio_pago', '$price', '$monto_ingresado', '$monto_vuelto')";
