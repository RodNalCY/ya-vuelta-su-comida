...
<head>
  ...
  <title>Sabrosoon Food, su comida</title>
        ...
        <form method="post">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <div id="nameHelp" class="form-text">Ingrese su nombre completo.</div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <input type="number" class="form-control" id="txtCantidad" aria-describedby="cantidadHelp" required placeholder="0">
                <div id="cantidadHelp" class="form-text" minlength="1" maxlength="5">Ingrese cantidad de pedido máximo 5.</div>
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <div id="emailHelp" class="form-text">Ingrese su número de celular.</div>
